...
namespace Inmobiliaria.API.Controllers
{
    ...
    public class SimulacionesController : ControllerBase
    {
        ...
        public async Task<IActionResult> CalcularYGuardarSimulacion([FromBody] SimulacionInputDto input)
        {
            ...
            try
            {
                ...
                var nuevaConfig = new Configfinanciera {
                    ...
                    DiasPorPeriodo = input.DiasPorPeriodo,
                ...
                var simulacionDb = new Simulacione
                {
                    ...
                    MontoPrestamo = (decimal)(input.PrecioVivienda - input.CuotaInicial),
        ...
        {
            var userIdClaim = User.FindFirst(ClaimTypes.NameIdentifier)?.Value;
            if (string.IsNullOrEmpty(userIdClaim) || !int.TryParse(userIdClaim, out int usuarioId)) return Unauthorized("Token inválido.");
            ...
            var historial = await _context.Simulaciones
                ...
                .Select(s => new
                {
                    ...
                    PrecioVenta = s.Propiedad != null ? s.Propiedad.PrecioVenta : 0m,
                    s.FechaSimulacion,
                    s.MontoPrestamo,
                    s.Tcea,
                    s.Van,
                    s.Tir,
                    Plazo = s.Config != null ? s.Config.PlazoMeses : 0,
                    ...
                    DiasPorPeriodo = s.Config != null ? s.Config.DiasPorPeriodo : 30,
        ...
        public async Task<IActionResult> ActualizarSimulacion(int id, [FromBody] SimulacionInputDto input)
        {
            ...
            try
            {
                ...
                if (simulacionDb.Config != null)
                {
                    ...
                    simulacionDb.Config.CuotaInicial = input.CuotaInicial;
                    ...
                    simulacionDb.Config.DiasPorPeriodo = input.DiasPorPeriodo;
                ...
                simulacionDb.MontoPrestamo = (decimal)(input.PrecioVivienda - input.CuotaInicial);
